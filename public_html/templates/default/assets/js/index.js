...
const swiper = new Swiper(".swiper-top", { loop: !0, autoplay: { delay: 7e3 }, effect: "fade", pagination: { el: ".swiper-pagination-top" }, navigation: { nextEl: ".swiper-button-next-top", prevEl: ".swiper-button-prev-top" } }),
	swiperReviews = new Swiper(".swiper-reviews", {
		 loop: !0,
		 autoplay: { delay: 2e3 },
		 breakpoints: { 1100: { slidesPerView: 2, spaceBetween: 30 }, 1215: { slidesPerView: 3 } },
	...
	cancel = document.querySelector(".popup__content-cancel"),
	sendBtn = document.querySelector(".send-btn"),
	form = document.querySelector(".popup__content-form"),
	questionBtn = document.querySelector(".questions__form-btn");
btns.forEach((e) => {
	e.addEventListener("click", () => {
		 popup.classList.add("popup-active"), (document.body.style.overflow = "hidden");
	});
}),
	window.addEventListener("click", (e) => {
		 (e.target !== popup && e.target !== cancel) || (popup.classList.remove("popup-active"), (document.body.style.overflow = "visible"));
	}),
	/* sendBtn.addEventListener("click", () => {
		 popup.classList.remove("popup-active"), (document.body.style.overflow = "visible");
	}), */
...
const burgerBtn = document.querySelector(".burger__button"),
	...
	cancelburger = document.querySelector(".cancel__burger");
...
var burgerItemMenu = document.querySelector(".menu__burger");

burgerItemMenu.addEventListener('click', function(e) {
